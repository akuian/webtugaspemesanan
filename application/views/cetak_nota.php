...
<table border="1" style="border-collapse: collapse;">
	<tr>
		...
		<?php $no=0; foreach($this->trans->detail_pembelian($transaksi->id_transaksi) as $makanan): $no++; ?>
		<tr>
			<th><?=$no?></th>
			<th><?=$makanan->nama_makanan?></th>
			<th><?= number_format($makanan->harga)?></th>
			<th><?=$makanan->jumlah?></th>
			<th><?= number_format(($makanan->harga*$makanan->jumlah)) ?></th>
		</tr>
	<?php endforeach ?>
		<tr>
