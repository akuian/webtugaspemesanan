...
<div class="col-md-6">
	<table id="example" class="table table-hover table-striped">
		...
		<tbody>
			<?php $no=0; foreach($tampil_makanan as $makanan): $no++; ?>
			<tr>
				<td><?=$no?></td>
				...
				<td><a href="<?=base_url('index.php/transaksi/addcart/'.$makanan->id_makanan)?>" class="btn btn-info">Pesan</a></td>
			<?php elseif($makanan->stok==0): ?>
