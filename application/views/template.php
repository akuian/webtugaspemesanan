  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/makanan/dashboard')?>" class="logo"><b>ALL YOU CAN EAT</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="<?=base_url('index.php/makanan/')?>">
                          <i class="fa fa-dashboard"></i>
                          <span>Dashboard Restauran</span>
                      </a>
                  </li>

                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/makanan/restauran')?>" >
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/makanan')?>">Daftar makanan</a></li>
